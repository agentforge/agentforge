...
def is_code_segment(text, threshold=0.5, outer_weight=2):
    try:
        common_natural_language_words = {
            'the', 'and', 'to', 'of', 'in', 'on', 'a', 'an', 'for', 'with', 'about', 'as', 'by', 'at', 'from', 'that',
            'which', 'who', 'whom', 'whose', 'this', 'these', 'those', 'there', 'where', 'when', 'how', 'many', 'much',
            'several', 'some', 'few', 'less', 'own', 'other', 'new', 'old', 'long', 'short', 'high', 'low', 'wide', 'narrow'
        }
        ...
        is_code = (code_probability > threshold) and (code_probability > common_word_probability)
        print(is_code)
