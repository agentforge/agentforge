...
export const GENERATION_FIELDS: ConfigFields = {
  ...
  typical_p: { type: 'float', default: 1.0, tooltip: "Local typicality measures. Defaults to 1.0." },
  epsilon_cutoff: { type: 'float', default: 0.0, tooltip: "If set to float strictly between 0 and 1, only tokens with a conditional probability greater than epsilon_cutoff will be sampled. Defaults to 0.0." },
  eta_cutoff: { type: 'float', default: 0.0, tooltip: "Eta sampling. Defaults to 0.0." },
  diversity_penalty: { type: 'float', default: 0.0, tooltip: "This value is subtracted from a beam’s score if it generates a token same as any beam from other group at a particular time. Defaults to 0.0." },
  encoder_repetition_penalty: { type: 'float', default: 1.0, tooltip: "The paramater for encoder_repetition_penalty. Defaults to 1.0." },
  length_penalty: { type: 'float', default: 1.0, tooltip: "Exponential penalty to the length. Defaults to 1.0." },
  no_repeat_ngram_size: { type: 'int', default: 0, tooltip: "If set to an integer greater than 0, the model is not allowed to generate any ngrams (sequences of n tokens) that it has already generated. This can prevent repetitive outputs and increase the diversity of the generated text." },
