...
class Genus:
    ...
    cold_tolerate_fauna_genus = {
        "Single-celled organisms": {
            ...
            "Archaea": 0.8,
            "Protozoa": 0.7,
            "Unicellular Fungi (e.g., Yeasts)": 0.75,
            "Protists (e.g., Amoebas, Slime Molds)": 0.7,
            "Choanoflagellates": 0.65,
            "Ciliates (such as Paramecium)": 0.65,
            "Flagellates (e.g., Euglena)": 0.65
        },
        "Multi-celled organisms": {
            "Fungi": 0.6,
            "Molds": 0.6,
        ...
        "Complex lifeforms": {
            ...
            "Reptiles": 0.35,
            "Amphibians": 0.25,
            "Coleoptera (Beetles)": 0.45,
            "Lepidoptera (Butterflies and Moths)": 0.4,
            "Hymenoptera (Bees, Wasps, Ants)": 0.5,
            "Diptera (Flies)": 0.55,
            "Hemiptera (True Bugs)": 0.45,
            "Odonata (Dragonflies)": 0.4,
            "Orthoptera (Grasshoppers)": 0.5,
            "Araneae (Spiders)": 0.5,
            "Gastropoda (Snails)": 0.6,
            "Isoptera (Termites)": 0.45,
            "Lagomorpha (Rabbits)": 0.35,
            "Mantodea (Praying Mantises)": 0.45,
            "Blattodea (Cockroaches)": 0.55,
            "Myriapods": 0.5,
            "Arachnids": 0.5,
            "Felines": 0.3,
            "Canines": 0.3,
